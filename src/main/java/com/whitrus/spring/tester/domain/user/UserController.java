...
public class UserController {
	...
	@PatchMapping("/{userId}")
	public ResponseEntity<UserDTO> updateUser(@PathVariable Long userId, @RequestBody @Valid UserUpdateDTO userUpdateDTO, @RequestParam(defaultValue = "basic") String view){
