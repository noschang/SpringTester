...
public final class FieldMatchValidator implements ConstraintValidator<FieldMatch, Object>
{
	...
	{		
		try {
			...
			String messageTemplate = "An unexpected error occurred on FieldMatchValidator for fields '%1$s' and '%2$s'. This is probably a bug on the validator or a mispelled property name on the object being validated";
